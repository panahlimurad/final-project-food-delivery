...
function BasketModal({ setActiveModal, activeModal }) {
  const handleClose = () => {
          ...
          <table className="w-full h-full">
            <tbody>
             <tr className={`${styles.tableRow} relative  border-b-[1px] border-[#E0E0E0]`}>
                <td className="w-[68px] pr-8 max-[981px]:pr-4 max-[380px]:pr-2 max-[380px]:w-[40px]"><div className="w-[68px] h-[68px] max-[683px]:w-[48px] max-[683px]:h-[48px] max-[380px]:w-[38px] max-[380px]:h-[38px] "><Image src={pizza} alt="pizza"  /></div></td>
                <td className="w-3/5  max-[981px]:w-8/12  max-[922px]:w-3/5 max-[380px]:w-7/12 max-[328px]:w-3/5"><div><h3 className={`${styles.restaurantName}`}>Papa John’s Pizza Restaurant</h3> <p className={`${styles["restaurant-paragraf"]}`}>$15.80</p></div></td>
