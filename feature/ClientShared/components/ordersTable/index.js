...
import deleteBtn from '../../../public/icons/delete.svg'
        ...
        <table className="min-w-full text-left text-black text-sm font-light">
          <thead className="border-b font-normal dark:border-neutral-500">
            <tr>
              ...
              <th scope="col" className="px-6 py-4">Delivery Adress</th>
          ...
          <tbody>
            <tr className="border-b dark:border-neutral-500">
              ...
              <td className="whitespace-nowrap px-6 py-4">Mark</td>
              <td className="whitespace-nowrap px-6 py-4">Otto</td>
              <td className="whitespace-nowrap px-6 py-4 cursor-pointer"><img src={eyes} alt='..' /></td>
              <td className="whitespace-nowrap px-6 py-4 cursor-pointer"><img src={deleteBtn} alt='..' /></td>
            </tr>
            <tr className="border-b dark:border-neutral-500">
