                    ...
                    <tr className=' relative'>
                        <Td size="sm">
                            <div className='w-[45px] h-[45px]'>
                                <Image  src={data.img_url} alt='pizza' width={45} height={45} />
                        ...
                        <Td><span className='w-[25px] h-[25px] absolute right-2 top-6'><Image  src={deleteItem} alt='delete' width={45} height={45} /></span></Td>
                    </tr>
