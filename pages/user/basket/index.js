                ...
                <div className={`w-full h-full ${styles["basket-container"]} bg-[#F3F4F6]`}>
                    <ScrollBarContainer>
                        <table className="w-full h-full">
                            <thead>
                                <tr>
                                    <th colSpan={3} className={`${styles.tableRow} relative  border-b-[1px] border-[#E0E0E0]`} > <h5 className="pt-4 text-3xl">Your Basket</h5> <div className=" flex  items-center ml-4"><Image src={add} /><span className="flex gap-4 ml-4">1</span>items</div></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr className={`${styles.tableRow} relative  border-b-[1px] border-[#E0E0E0]`}>
                                    <td className="w-[68px] pr-8  pl-8 max-[981px]:pr-4 max-[380px]:pr-2 max-[380px]:w-[40px]"><div className="w-[68px] h-[68px] max-[683px]:w-[48px] max-[683px]:h-[48px] max-[380px]:w-[38px] max-[380px]:h-[38px] "><Image src={pizza} alt="pizza" /></div></td>
